...
<Warning>
  Depending on your Docker Compose installation, the commands described here as `docker-compose` may not work and should be replaced with `docker compose`.
</Warning>
