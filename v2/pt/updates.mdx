...
~~~ shell
docker compose pull atendai/evolution-api:2.1.0
~~~
...
# ... (outros serviços e configurações)
  evolution_api:
    ...
    # Ou especifique uma versão específica como 'atendai/evolutionapi:2.1.0'
...
~~~
    ...
    - Atualize o valor para `atendai/evolution-api:2.1.0` para a versão mais recente, ou use `atendai/evolutionapi:v2.x.x` para uma versão específica.
