...
~~~ shell
docker compose pull atendai/evolution-api:v2.0.9-rc
~~~
...
# ... (outros serviços e configurações)
  evolution_api:
    ...
    # Ou especifique uma versão específica como 'atendai/evolutionapi:v2.0.9-rc'
...
~~~
    ...
    - Atualize o valor para `atendai/evolution-api:v2.0.9-rc` para a versão mais recente, ou use `atendai/evolutionapi:v2.x.x` para uma versão específica.
