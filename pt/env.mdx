...
| `WEBSOCKET_ENABLED` | Habilitar ou não o WebSocket |
...
| Variável | Valor | Exemplo |
| --- | --- | --- |
| `REDIS_ENABLED` | Se o Redis está habilitado (true ou false) | true |
| `REDIS_URI` | A URI de conexão do Redis | redis://redis:6379 |
| `REDIS_PREFIX_KEY` | Prefixo do nome de chave | evo |
