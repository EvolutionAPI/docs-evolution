...
<Warning>
  A depender da sua instalação do Docker Compose, os comandos aqui descritos como `docker-compose` podem não
  funcionar e devem ser substituídos por `docker compose`
</Warning>
